...
resultado_quant = input("Quantos resultados você quer?\nEscreva um numero:")
path = input("Onde deseja salvar o arquivo?Escreva um local ou nome:")
...
while trabalho == True:
	cont = cont+10
	page = requests.get("https://www.google.com.br/search?q="+search+"&oq="+search+"&start="+str(cont))
